...
void            panic_concat(int count, ...) __attribute__((noreturn));
...
int             uvmcopy(pagetable_t, pagetable_t, int, int, uint64);
void            uvmfree(pagetable_t, uint64);
void            uvmunmap(pagetable_t, uint64, uint64, int);
void            uvmclear(pagetable_t, uint64);
pte_t *         walk(pagetable_t, uint64, int);
uint64          walkaddr(pagetable_t,int, uint64);
int             copyout(pagetable_t, int, uint64, char *, uint64);
int             copyin(pagetable_t, int, char *, uint64, uint64);
int             copyinstr(pagetable_t, int, char *, uint64, uint64);
...
void            virtio_disk_rw(int id, struct buf *, int, int);
